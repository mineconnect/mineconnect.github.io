...
export default function DriverSimulator({ user, onTripUpdate }: DriverSimulatorProps) {
  ...
  return (
    <div className="h-screen bg-dark-primary flex items-center justify-center p-4 safe-area">
      <div className="w-full max-w-4xl">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="bg-slate-900/95 backdrop-blur-xl rounded-[2rem] border border-slate-700 shadow-2xl overflow-hidden mobile-landscape-compact"
        >
          {/* Header */}
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-6 safe-area-top">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-blue-100 mt-2 text-sm">Simulador Avanzado de Telemetría</p>
              </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
              <div className="text-center">
                ...
                <div className="text-sm lg:text-lg font-semibold flex items-center justify-center space-x-2 mt-1">
                  <Activity className={`w-4 h-4 lg:w-5 lg:h-5 ${isTracking ? 'text-accent animate-pulse' : 'text-slate-500'}`} />
              ...
              <div className="text-center">
                <div className="text-xs text-slate-400 uppercase tracking-wider">Velocidad</div>
              ...
              <div className="text-center">
                <div className="text-xs text-slate-400 uppercase tracking-wider">Tiempo</div>
              ...
              {gpsAccuracy !== null && (
                <div className="text-center">
                  <div className="text-xs text-slate-400 uppercase tracking-wider">Precisión</div>
          ...
          <div className="p-6 lg:p-8">
            <div className="flex flex-col items-center space-y-6">
              ...
              >
                <div className={`absolute inset-0 rounded-full ${isTracking ? 'animate-pulse' : 'animate-ping'} opacity-30 bg-current`}></div>
              ...
              {currentPosition && (
                <motion.div 
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  className="w-full bg-slate-800/50 backdrop-blur-sm rounded-xl p-4 border border-slate-700 hardware-accelerated"
                >
                  <div className="flex items-center space-x-2 text-sm">
                    <MapPin className="w-4 h-4 text-primary flex-shrink-0" />
                    <span className="text-slate-300 text-xs lg:text-sm break-all">
            ...
            <div className="mt-6">
              ...
              <div
                ref={logContainerRef}
                className="bg-slate-950/50 backdrop-blur-sm rounded-xl border border-slate-800 p-4 h-48 sm:h-56 overflow-y-auto font-mono text-xs custom-scrollbar hardware-accelerated"
              >
                {gpsLogs.length === 0 ? (
